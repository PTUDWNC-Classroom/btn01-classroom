...
export function GradeAssignmentCard({ _id, gradeTitle, gradeDetail, disableState, index, handleDisable }) {
    ...
    const handleUpdate = async (_id)=>
    {
        ...
        const UpdateAssignment = async () => {
            try {
              ...
              const response = await axios.post("http://localhost:3000/assignment/updateAssignment",
                {
                  classId: "vd",
                  _id: _id,
    ...
    const handleDelete = async (_id)=>
    {
        ...
        const DeleteAssignment = async () => {
            try {
              ...
              const response = await axios.post("http://localhost:3000/assignment/deleteAssignment",
                {
                  classId: "vd",
                  _id: _id,
                }
...
export function AddGradeAssignmentCard() {
    ...
    const handleSubmit = async () => {
        ...
        const AddAssignment = async () => {
            try {
              ...
              const response = await axios.post("http://localhost:3000/assignment/addAssignment",
                {
                  classId: "vd",
    ...
    return (
        <Paper onSubmit={handleSubmit} sx={{ maxWidth: 400, my: 1, mx: 'auto', p: 2 }}>
            <Grid container wrap="nowrap" spacing={4}>
                <Grid item xs zeroMinWidth>
                    <Stack
                        component="form"
